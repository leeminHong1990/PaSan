var PSGameRoomSceneUIManager = UIManagerBase.extend({
	...
	onCreate: function () {
		var initUIClassNameList = ["AudioRecordUI", "HelpUI", "ConfigUI", "ConfirmUI","GamePlayerInfoUI", "CommunicateUI", "ApplyCloseUI","GPSceneUI","ClubInviteUI"];
