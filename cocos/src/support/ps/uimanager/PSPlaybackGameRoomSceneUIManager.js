var PSPlaybackGameRoomSceneUIManager = UIManagerBase.extend({
	...
	onCreate: function () {
		var initUIClassNameList = ["GamePlayerInfoUI", "HelpUI", "PlaybackControlUI", "PSPlayBackUI"];
		...
		this.playback_ui = this.PSplayback_ui;
		this.PSplayback_ui = null;
		this.backgroundStrategy = new PSBackgroundStrategy(this, table_config[this.gameType]["BG_INFO"]);
