...
const_val.EXPRESSION_ANIM_LIST = ["flower", "egg", "cheers", "boom"];	//魔法表情(扔钱的动画是由一张图片做的，这里写出来是为了保证它的长度正确)
const_val.EXPRESSION_ANIMNUM_LIST = [32, 16, 15, 8];	//魔法表情的帧数
...
const_val.ENTER_FAILED_ROOM_HALFWAY_JOIN			= -10; // 不允许中途进入房间
const_val.ENTER_FAILED_ROOM_BLACK					= -11; // 在亲友圈房间黑名单中
/* ####################################  房间开房的一些模式 ################################## */
...
const_val.CLUB_OP_ADD_TABLE       = 33//增加亲友圈桌子
...
const_val.STOOL_POS = [[],[],[],[cc.p(0.50, 0.85), cc.p(0.22, 0.45), cc.p(0.78, 0.45)],
						...
						[cc.p(0.50, 0.82),cc.p(0.24, 0.62), cc.p(0.35, 0.34), cc.p(0.65, 0.34), cc.p(0.76, 0.62)],
						[cc.p(0.50, 0.85),cc.p(0.24, 0.68), cc.p(0.24, 0.40), cc.p(0.50, 0.27), cc.p(0.76, 0.40), cc.p(0.76, 0.68)]];

// 亲友圈头像位置
const_val.PLAYER_POS = [[],[],[],[cc.p(0.50, 0.85), cc.p(0.22, 0.45), cc.p(0.78, 0.45)],
	[cc.p(0.50, 0.85),cc.p(0.21, 0.56), cc.p(0.50, 0.27), cc.p(0.79, 0.56)],
	[cc.p(0.50, 0.85),cc.p(0.21, 0.62), cc.p(0.33, 0.31), cc.p(0.67, 0.31), cc.p(0.79, 0.62)],
	[cc.p(0.50, 0.85),cc.p(0.24, 0.68), cc.p(0.24, 0.40), cc.p(0.50, 0.27), cc.p(0.76, 0.40), cc.p(0.76, 0.68)]];
...
const_val.GameType2GameName[const_val.PaSan] 		= 'PS';
...
const_val.GameType2CName[const_val.PaSan] 		= '爬三';
...
const_val.GameType2CNum[const_val.PaSan] 		= 5;
